...
//     enviar_boas_vindas(msg);
// } else {
//     let num = msg.from;
//     if (bemVindoEnviado.indexOf(num) == -1) {
//         enviar_boas_vindas(msg);
//     }
// }

// async function enviar_boas_vindas(msg) {
//     let numeroo = msg.from;
//     bemVindoEnviado.push(numeroo);

//     client.sendMessage(msg.from, 'Bem-Vindo mensagem').then(() => {
